...
To contribute to ansible-role-authorization project on [GitHub](https://github.com/hadenlabs/ansible-role-authorization), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/ansible-role-authorization/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to ansible-role-authorization project on Gitlab:
...
```bash
git remote add upstream  https://github.com/hadenlabs/ansible-role-authorization.git
```

Now your **upstream** points to **hadenlabs/ansible-role-authorization**.
...
git fetch upstream # assuming upstream is rfid/ansible-role-authorization
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/ansible-role-authorization/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
